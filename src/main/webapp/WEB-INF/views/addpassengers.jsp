        ...
        <body>
			...
			<div class="row" style="margin: 10px; padding: 10px">
				...
				<div class="col-sm-8 col-12 p-2">
					<div id="PassengerDiv">
						...
						<c:forEach
							items="${sessionScope.listOfPassenger}"
							var="passenger"
							varStatus="loop"
						>
							<div class="card mt-2">
								<div class="card-body">
									<div
										class="d-flex flex-row bd-highlight justify-content-around"
									>
										...
										<c:choose>
											<c:when
												test="${passenger.getSeatPreference() eq '2S'}"
											>
												<div
													class="p-2 bd-highlight text-success font-weight-bold"
												>
													Rs.150
												</div>
											</c:when>
											...
											<c:when
												test="${passenger.getSeatPreference() eq 'SL'}"
											>
												<div
													class="p-2 bd-highlight text-success font-weight-bold"
												>
										...
										<div class="p-2 bd-highlight">
											<a
												href="/book/${selectedTrain.getTrainNo()}/removepassenger/${loop.index}"
												><em
            ...
            <c:if test="${listOfPassenger.size()>0 }">
                <div style="position: relative">
                    <a class="btn mt-3 btn-success" style="position: absolute; right: 0" href="">Total: ${sessionScope.totalAmount}</a
								>
							</div>
							<!--Card end-->
							...
							<div class="text-center">
								<a
									...
									href="/book/${selectedTrain.getTrainNo()}/payment"
