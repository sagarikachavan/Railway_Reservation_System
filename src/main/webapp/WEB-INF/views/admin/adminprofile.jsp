...
uri="http://java.sun.com/jsp/jstl/core"%>
        ...
        <body>
                    ...
                    <li class="nav-item dropdown">
						...
						<li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" id="drop-down1" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/viewusers">View Users</a
								>
							</div>
						</li>
						<li class="nav-item active">
			...
			<form
				action="/updateuser"
				onsubmit="return disableinputs()"
				id="colorred"
				method="post"
			>
				<div class="row user_box">
					<div
						class="col-md-12 col-xs-12 mt-4 follow line text-center"
					>
						<h3 class="mt-2">
							Hi, ${sessionScope.currentUser.getFirstName()}
						</h3>
					</div>
					...
					<div
						class="col-md-12 col-xs-12 user_control handle"
						id="formFields"
					>
						<div class="control">
							<div class="label">
							...
							<div class="label">
								...
								<span
									><input
										type="text"
										name="mobileNumber"
										value="${currentUser.getMobileNumber() }"
								/></span>
							</div>
							<p class="text-white"></p>
						</div>
