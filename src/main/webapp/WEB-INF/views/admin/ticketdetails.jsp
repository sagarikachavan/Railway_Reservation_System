...
prefix="c"%>
        ...
        <head>
            ...
            <script>
                function tabchange1() {
                    document
                        .getElementById("nav-ticket-tab")
                        .classList.remove("bg-dark", "text-light");
                    document
                        .getElementById("nav-passenger-tab")
        ...
        <body>
            <div class="container" style="padding: 0">
				...
				>
                    ...
                    <div class="dropdown-menu" id="drop-down" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="/trainform">Add Trains</a
								>
								<a class="dropdown-item" href="/viewtrains"
									>View Trains</a
								>
							</div>
						</li>
						...
						<li class="nav-item active">
							<a class="nav-link" href="/ticketdetails"
								>Ticket Details<span class="sr-only"
									>(current)</span
								>
							</a>
                            </li>
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-10 mt-3">
										...
										<tbody class="">
											...
											>
												<tr>
													...
													<td>
														<a
															href="/cancelticket/${ticket.getTicketID()}"
															><em
																class="bi text-danger bi-trash"
															></em
														></a>
                                    </td>
                                    </tr>
                    ...
                    <div class="tab-pane fade show" id="nav-passenger" role="tabpanel" aria-labelledby="nav-passenger-tab">
                        <div class="tab-pane fade show active" id="nav-passenger" role="tabpanel" aria-labelledby="nav-passenger-tab">
                            <div class="table-responsive mt-2">
                                <div class="table-wrapper">
                                    <table class="table table-striped table-hover text-center" aria-describedby="passengers">
                                        ...
                                        <tbody class="">
                                            <c:forEach var="ticket" items="${ticketDetails}">
                                                <c:forEach var="passenger" items="${ticket.getListOfPassenger()}">
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ${passenger.getTicketId().getTicketID()}
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </c:forEach>
