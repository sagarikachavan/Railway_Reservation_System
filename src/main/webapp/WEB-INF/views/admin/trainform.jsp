        ...
        <body>
            <div class="container" style="padding: 0; position: relative">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
					...
					Welcome, ${sessionScope.currentUser.getFirstName()}</a
				>
				<button
				...
				<div class="row justify-content-md-center mt-5">
					...
					<div class="col-12 col-sm-4">
						<div class="form-group">
							<label for="formGroupExampleInput0">Train No</label>
							<input
								type="text"
								class="form-control"
						...
						<div class="form-group">
							<label for="formGroupExampleInput2">2S Seats</label>
							<input
								type="text"
								class="form-control"
						...
						<div class="form-group">
							<label for="formGroupExampleInput3">SL Seats</label>
							<input
								type="text"
								class="form-control"
						...
						<div class="form-group">
							<label for="formGroupExampleInput4">AC Seats</label>
							<input
								type="text"
								class="form-control"
					...
					<div class="col-12 col-sm-4">
						...
						<div class="form-group">
							<label for="formGroupExampleInput5">From</label>
							<input
								type="text"
								class="form-control"
						...
						<div class="form-group">
							<label for="formGroupExampleInput6">To</label>
							<input
								type="text"
								class="form-control"
