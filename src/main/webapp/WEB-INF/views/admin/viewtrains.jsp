						...
						<tbody>
							...
							<c:forEach var="train" items="${listOfTrains}">
								<tr>
									...
									<td>
										<a
											href="/getfulldetails?trainName=${train.getTrainName()}"
											>${train.getTrainName()}</a
										>
									</td>
									...
									<td>
										<a
											href="/updateTrainModal/${train.getTrainNo()}"
											><em
												class="bi text-info bi-pencil-square"
											></em
										></a> &nbsp
                                    <a href="/deletetrain/${train.getTrainNo()}"><em
