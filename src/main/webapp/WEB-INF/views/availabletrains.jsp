				...
				<c:forEach var="train" items="${listOfAvailTrains}">
					<div class="card mb-3" id="traincard">
						<div class="card-header text-dark">
							<span
								>${train.getSource()} -
								${train.getDestination()}</span
							>
							<span class="float-right"
								>Depature Time: ${train.getDepatureTime()}</span
							>
						</div>
						<div class="card-body text-white">
							<div class="row">
								<div
									class="col-sm-4 col-4 bg-danger text-center"
								>
									<h6 class="mt-1 text-center card-title">
										${train.getTrainName()}
									</h6>
									<h6>${train.getTrainNo()}</h6>
								</div>
								<div
									class="col-sm-4 col-4 bg-info table-responsive"
								>
									<table
										class="mt-1"
