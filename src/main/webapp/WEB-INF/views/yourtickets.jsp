...
prefix="c"%>
        ...
        <body>
            <div class="container" style="padding: 0">
                ...
                <nav class="navbar w-100 navbar-expand-lg navbar-light" style="margin: 0px">
				...
				>
					<div class="card col-12 col-md-7 mt-2">
						<h6 class="card-title mt-2">
							...
							${ticket.getTrainId().getDestination()}<span
								class="float-right"
								>${ticket.getTrainId().getTrainNo()}</span
							>
						</h6>
						...
						>
							...
							<div class="p-2 bd-highlight">
								...
								<p>
									...
									<em
										class="bi text-success bi-check-lg"
									></em>
								</p>
							</div>
            ...
            <a data-toggle="collapse" href="#collapseExample${loop.index}" role="button" aria-expanded="false" aria-controls="collapseExample">
							View Passengers
						</a>
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <table class="table table-striped table-hover" aria-describedby="passengers">
                            ...
                            <c:forEach items="${ticket.getListOfPassenger()}" var="passenger">
                                <tr>
                                    <td>
            ...
            <!--Confirmation Modal -->
            <div class="modal fade" id="staticBackdrop${loop.index}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Do you want to cancel your ticket?/div>
                            <div class="modal-footer">
                                <a type="button" href="/cancelticket/${ticket.getTicketID()}" class="btn text-white bg-danger">Yes</a
									>
									<button
										type="button"
										class="btn btn-info"
